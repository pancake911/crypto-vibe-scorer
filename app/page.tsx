                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div className="text-sm text-bloomberg-text-dim">
                            {record.fundingRate !== null && `费率: ${(record.fundingRate * 100).toFixed(4)}%`}
          ...
          <div className="bg-bloomberg-darker border border-bloomberg-border rounded-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-bloomberg-dark rounded border border-bloomberg-border">
                ...
                <div className={`text-2xl font-bold ${
                  fundingRate !== null && fundingRate > 0.07 ? 'text-bloomberg-red' :
                  fundingRate !== null && fundingRate < -0.01 ? 'text-bloomberg-green' :
                  'text-bloomberg-text'
                }`}>
                  {fundingRate !== null ? `${fundingRate.toFixed(4)}%` : loading ? '获取中...' : '未获取'}
                </div>
                {fundingRate !== null && (
                  <div className="text-xs text-bloomberg-text-dim mt-1">
                    {fundingRate > 0.07 ? '⚠️ 极度危险' : 
                     fundingRate > 0 ? '多头付费' : 
                     fundingRate < -0.01 ? '✅ 空头付费（做多机会）' : '中性'}
                  </div>
                )}
